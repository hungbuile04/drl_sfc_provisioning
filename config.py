# config.py
"""Configuration for DRL SFC Provisioning"""
...
TIME_STEP = 1  # 1ms per step
TRAFFIC_GEN_INTERVAL = 5  # Generate every 5ms
...
# --- DRL SETTINGS ---
ACTION_SPACE_SIZE = 2 * NUM_VNF_TYPES + 1  # Wait + Uninstall*6 + Alloc*6
LEARNING_RATE = 0.001
GAMMA = 0.95
EPSILON_START = 1.0
EPSILON_DECAY = 0.99
