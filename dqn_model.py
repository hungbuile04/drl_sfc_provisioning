"""
DQN Model Architecture with Multi-Input and Attention Mechanism
"""
import os
...
def build_q_network():
    """
    Build Q-Network with multi-input architecture and attention
    
    Architecture:
    - Input 1: DC Info [2|V|+2] = 14
    - Input 2: DC-SFC Info [|S|(1+2|V|)] = 78
    - Input 3: Global SFC Info [|S|(4+|V|)] = 60
    - Concatenate -> Attention -> FC layers -> Output [2|V|+1] = 13
    """
    ...
    # --- Output Layer ---
    output = layers.Dense(config.ACTION_SPACE_SIZE, activation='linear', name="Q_Values")(fc2)
